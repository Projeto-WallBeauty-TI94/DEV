    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <div class="w-container"><a href="/" class="brand-link w-nav-brand">
            ...
            <nav role="navigation" class="navigation-menu w-nav-menu"><a href="index.php"
                    class="navigation-link w-nav-link">Inicio</a><a href="user.php" aria-current="page"
                    class="navigation-link w-nav-link w--current">Login</a></nav>
            <div class="hamburger-button w-nav-button">
                <div class="w-icon-nav-menu"></div>
            </div>
        </div>
    </div>
    <div class="w-widget w-widget-map" data-widget-style="roadmap" data-widget-latlng="37.77493,-122.419416"
        data-enable-scroll="false" data-disable-scroll="1" role="" title="" data-enable-touch="true"
        data-widget-zoom="12" data-widget-tooltip=""></div>
    <div class="section">
        <div class="w-container loginForm">
            ...
            <div class="form-wrapper w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="post" class="form">
                    ...
                    <input type="submit" value="Logar" data-wait="Please wait..." class="button full-width w-button" /><br>
                    <p>OU</p>
