    ...
    <div class="section">
        ...
        <div class="w-container cadastroForm">
            ...
            <div class="form-wrapper w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="post" class="form" onsubmit="return validarFormulario();">
                    <input type="text" class="form-field w-input" maxlength="256" name="name" data-name="name" placeholder="Digite seu nome e sobrenome..." id="name" required="" /> 
                    <input id="fone" type="text" class="form-field w-input" maxlength="16" pattern="\([0-9]{2}\) [0-9]{5}-[0-9]{4}" name="fone" data-name="fone" placeholder="Digite um número de telefone..." id="fone" required="" />
                    ...
                    <input type="email" class="form-field w-input" maxlength="256" name="Email2" data-name="Email2" placeholder="Confirme seu e-mail..." id="Email2" required="" />  
                    ...
                    <input type="password" class="form-field w-input" maxlength="256" name="senha2" data-name="senha2" placeholder="Confirme sua senha..." id="senha2" required="" />
                    <input type="submit" value="Cadastrar" class="button full-width w-button" /><br>
                    <p>OU</p>
